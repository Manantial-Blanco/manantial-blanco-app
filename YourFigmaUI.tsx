    ...
    <div className="min-h-screen w-full flex flex-col bg-white font-['SF_Compact_Display']">
      ...
      <header className="bg-black px-6 md:px-12 py-4 relative">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-8">
            <a
              href="#"
              className="text-white text-[15px] leading-5 hover:text-cream transition-colors"
            >
              Home
            </a>
            <a
            ...
            <a
              ...
              className="text-[#F1E7D3] text-2xl leading-5 flex items-center gap-1 hover:text-white transition-colors"
            >
              Explore Licensed Art
              <ChevronDown className="w-4 h-4" />
            </a>
            <a
              href="#"
              className="text-white text-[15px] leading-5 flex items-center gap-1 hover:text-cream transition-colors"
            >
              About Us
              <ChevronDown className="w-4 h-4" />
            </a>
          ...
          <div className="flex items-center gap-6">
            <Search className="w-6 h-6 text-white cursor-pointer hover:text-cream transition-colors" />
            <User className="w-6 h-6 text-white cursor-pointer hover:text-cream transition-colors" />
            <ShoppingBag className="w-6 h-6 text-white cursor-pointer hover:text-cream transition-colors" />
          </div>
        </div>
      </header>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          <h1 className="text-[#F1E7D3] text-5xl md:text-7xl lg:text-[90px] font-semibold leading-tight tracking-[-0.02em] mb-4">
            Register, remix and monetize your art
          </h1>
          <p className="text-white text-lg md:text-2xl leading-relaxed max-w-4xl mx-auto mb-8 tracking-[-0.02em]">
            The first platform that puts Latin American creators in control of
            their cultural assets—with verified ownership, global licensing, and
            automatic royalty payments.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            <button className="px-8 py-4 border-2 border-[#F1E7D3] rounded-full text-[#F1E7D3] text-2xl leading-5 font-['Public_Sans'] hover:bg-[#F1E7D3] hover:text-black transition-all">
              Register Your Cultural IP
            </button>
            <button className="px-8 py-4 bg-[#F1E7D3] rounded-full text-black text-2xl leading-5 font-['Public_Sans'] hover:bg-white transition-all">
              Explore Licensed Art
            </button>
          </div>
        </div>
      ...
      <div className="py-12 text-center">
        <h2 className="text-black text-4xl font-bold leading-4">
          Your Cultural IP. Your Rules. Your Royalties. Forever.
        </h2>
      </div>
      ...
      <div className="px-6 md:px-12 pb-12">
        ...
        <div className="border-b border-[#2C2C2C] pb-6 mb-6">
          <div className="flex items-center gap-3">
            <div className="flex-1 flex items-center gap-2 px-3 py-2 border border-[#E3E3E3] bg-[#E3E3E3]/20 rounded-2xl">
              ...
              <input
                type="text"
                placeholder="an illustration inspired on dia de muertos"
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 px-4 py-2 border border-black rounded">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center gap-8 p-6">
            ...
            <div>
              ...
              <p className="text-[#D6DDE6] text-[17px] font-['SF_Compact'] leading-7">
                Registering a piece of art IP means legally protecting your
                creative work. It ensures that you have exclusive rights to use
                and distribute your artwork, preventing unauthorized use by
                others.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-8 p-6">
            ...
            <div>
              ...
              <p className="text-[#D6DDE6] text-[17px] font-['SF_Compact'] leading-7">
                Releasing a remix means publishing your new version of an
                artwork, often under specific licenses that dictate how it can
                be used. This allows others to appreciate and potentially build
                upon your creative reinterpretation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 md:px-12 py-12">
        <h2 className="text-black text-5xl font-bold leading-tight tracking-[-0.01em] text-center mb-12 font-['Plus_Jakarta_Sans']">
          Artists are thriving with Manantial Blanco
        </h2>
        ...
        <div className="flex overflow-x-auto gap-6 pb-6">
          {[
            ...
            },
            {
              ...
              role: "Painter",
              quote:
                "I can finally focus on creating while Manantial Blanco handles the rest.",
      ...
      <footer className="bg-white px-6 md:px-12 pb-12">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex flex-col gap-4 lg:w-[400px]">
            <div>
              <h4 className="text-black text-[15px] leading-5">Newsletter</h4>
