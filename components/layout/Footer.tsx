...
export default function Footer({ dict }: FooterProps) {
  return (
    <footer className="bg-white px-6 md:px-12 py-12">
      <div className="w-full h-px bg-black mb-8" />

      {/* Mobile Layout */}
      <div className="lg:hidden max-w-sm mx-auto flex flex-col items-center">
        {/* Logo */}
        <div className="mb-6">
          <Image
        ...
        <div className="grid grid-cols-2 gap-6 mb-8 w-fit mx-auto max-w-xs">
          {/* Company Links */}
          <div className="flex flex-col gap-2 text-left min-w-0">
            <h4 className="text-black text-[15px] font-sf-compact leading-5 mb-2" style={{ fontWeight: 457 }}>
              {dict.landing.footer.company}
            </h4>
            <a
              href="#"
              className="text-black text-[15px] font-sf-compact leading-5 hover:underline transition-all duration-200"
              style={{ fontWeight: 457 }}
            >
        ...
        <div className="w-full text-left">
          ...
          <div className="flex flex-row gap-3 w-full">
            <input
              ...
              className="flex-1 px-3 h-[32px] border-2 border-black rounded-[8px] outline-none text-[14px] font-sf-compact leading-5 focus:border-black transition-all duration-200 bg-white placeholder:text-black min-w-0"
              aria-label={dict.landing.footer.emailPlaceholder}
            />
            <button className="px-3 h-[32px] bg-white border-2 border-black text-black text-[14px] font-sf-compact leading-5 rounded-[8px] hover:bg-gray-50 active:bg-gray-100 transition-colors duration-200 whitespace-nowrap flex items-center justify-center flex-shrink-0">
      ...
      <div className="hidden lg:flex lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="text-black text-[15px] font-sf-compact leading-5 mb-1" style={{ fontWeight: 457 }}>
              {dict.landing.footer.company}
            </h4>
            <a
              href="#"
