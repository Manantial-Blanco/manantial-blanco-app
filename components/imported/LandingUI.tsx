...
export default function LandingUI({ dict, lang, pieces = [] }: LandingUIProps) {
  ...
  // Use placeholder data if no pieces provided
  const displayPieces = pieces.length > 0 
    ? pieces 
    : Array(8).fill(null).map((_, i) => ({
        id: `placeholder-${i}`,
        title: 'Alebrije Alado',
        imageUrl: 'https://api.builder.io/api/v1/image/assets/TEMP/48aa5b824a85d8fa5303beb1454b088c338a765a?width=636',
  ...
  const testimonials = [
    {
      ...
      img: 'https://api.builder.io/api/v1/image/assets/TEMP/721726096569fcd42686bc675dd5b6b141a174f8?width=96',
    },
    {
      name: 'Lysandra Velez',
      role: 'Painter',
      quote: 'I can finally focus on creating while Manantial Blanco handles the rest.',
      img: 'https://api.builder.io/api/v1/image/assets/TEMP/8e1cf746a3c23932e49e8b2a55fc988c7dcdecf7?width=96',
    },
    {
      name: 'Joaquin Fierro',
      role: 'Sculptor',
      quote: 'The best platform for artists to monetize their work.',
      img: 'https://api.builder.io/api/v1/image/assets/TEMP/f555bff34fbe120e5e2d988cf1fa021f262e62f1?width=96',
    },
  ];

  return (
    <div className="min-h-screen w-full flex flex-col bg-white font-['SF_Compact_Display']">
      {/* Promo Banner */}
      {showBanner && (
        <div className="relative flex items-center justify-center bg-[#F1E7D3] px-6 md:px-12 py-2">
          <p className="text-black text-[13px] leading-4 text-center">
            {dict.landing.promoBanner}
          </p>
          <button
            onClick={() => setShowBanner(false)}
            className="absolute right-6 md:right-12 w-6 h-6 flex items-center justify-center"
      ...
      <header className="bg-black px-6 md:px-12 py-4 relative">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-8">
            <Link
              href={`/${lang}/landing`}
              className="text-white text-[15px] leading-5 hover:text-[#F1E7D3] transition-colors"
            >
              {dict.common.home}
            </Link>
            <Link
              href={`/${lang}/login`}
              className="text-[#F1E7D3] text-2xl leading-5 flex items-center gap-1 hover:text-white transition-colors"
            >
            ...
            <Link
              href="#"
              className="text-white text-[15px] leading-5 flex items-center gap-1 hover:text-[#F1E7D3] transition-colors"
            >
              {dict.common.about}
              <ChevronDown className="w-4 h-4" />
            </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <Search className="w-6 h-6 text-white cursor-pointer hover:text-[#F1E7D3] transition-colors" aria-label="Search" />
            <Link href={`/${lang}/login`}>
              <User className="w-6 h-6 text-white cursor-pointer hover:text-[#F1E7D3] transition-colors" aria-label="User account" />
            </Link>
            <ShoppingBag className="w-6 h-6 text-white cursor-pointer hover:text-[#F1E7D3] transition-colors" aria-label="Shopping bag" />
          </div>
        </div>
      </header>
      ...
      {/* Hero Section */}
      <section
        className="relative w-full h-[725px] bg-gradient-to-b from-black/20 to-black/20 flex items-center justify-center"
        style={{
          backgroundImage:
            "linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), url('https://api.builder.io/api/v1/image/assets/TEMP/1381024a62d64052c6d9c6ee8fea230634bdc4ef?width=2886')",
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      >
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          <h1 className="text-[#F1E7D3] text-5xl md:text-7xl lg:text-[90px] font-semibold leading-tight tracking-[-0.02em] mb-4">
            {dict.landing.heroTitle}
          </h1>
          <p className="text-white text-lg md:text-2xl leading-relaxed max-w-4xl mx-auto mb-8 tracking-[-0.02em]">
            {dict.landing.heroDescription}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            <Link
              href={`/${lang}/login`}
              className="px-8 py-4 border-2 border-[#F1E7D3] rounded-full text-[#F1E7D3] text-2xl leading-5 font-['Public_Sans'] hover:bg-[#F1E7D3] hover:text-black transition-all"
            >
              {dict.landing.registerCTA}
            </Link>
            <a
              href="#catalog"
              className="px-8 py-4 bg-[#F1E7D3] rounded-full text-black text-2xl leading-5 font-['Public_Sans'] hover:bg-white transition-all"
            >
              {dict.landing.exploreCTA}
            </a>
          </div>
      ...
      <div className="py-12 text-center">
        <h2 className="text-black text-4xl font-bold leading-4">
          {dict.landing.tagline}
        </h2>
      </div>

      {/* Explore Section */}
      <div id="catalog" className="px-6 md:px-12 pb-12">
        <h2 className="text-black text-[32px] font-semibold leading-5 text-center mb-10">
          {dict.landing.exploreTitle}
        </h2>

        {/* Categories */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-6">
          <div className="flex items-center justify-center gap-2 p-4 border-2 border-[#F1E7D3] bg-[#F1E7D3] rounded-lg">
            <svg
              width="20"
              height="16"
              viewBox="0 0 21 17"
          ...
          <div className="flex items-center justify-center gap-2 p-4 border-2 border-[#F1E7D3] bg-[#F1E7D3] rounded-lg">
            ...
            >
              <path
                d="M6.99524 0.87793V12.6002C6.35607 12.2224 5.61941 11.989 4.82857 11.989C2.43441 11.989 0.495239 13.9779 0.495239 16.4335C0.495239 18.889 2.43441 20.8779 4.82857 20.8779C7.22274 20.8779 9.16191 18.889 9.16191 16.4335V5.32237H13.4952V0.87793H6.99524ZM4.82857 18.6557C3.63691 18.6557 2.66191 17.6557 2.66191 16.4335C2.66191 15.2113 3.63691 14.2113 4.82857 14.2113C6.02024 14.2113 6.99524 15.2113 6.99524 16.4335C6.99524 17.6557 6.02024 18.6557 4.82857 18.6557Z"
                fill="black"
              />
            </svg>
            <span className="text-black text-2xl font-semibold leading-5">
              {dict.landing.categories.music}
            </span>
          </div>
          <div className="flex items-center justify-center gap-2 p-4 border-2 border-[#F1E7D3] bg-[#F1E7D3] rounded-lg">
            <svg
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-black text-[32px] font-semibold leading-5">
              {dict.landing.recommendedTitle}
            </h3>
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 px-4 py-2 border border-black rounded" aria-label="Sort options">
                <span className="text-black text-[15px] leading-5">
                  {dict.common.sortBy}
                </span>
                <ChevronDown className="w-4 h-4" />
              </button>
              <button className="flex items-center gap-2 px-4 py-2 border border-black rounded" aria-label="Category filter">
                <span className="text-black text-[15px] leading-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            {displayPieces.slice(0, 8).map((piece, i) => (
              <Link key={piece.id} href={`/${lang}/piece/${piece.id}`} className="flex flex-col gap-3">
                <div className="relative rounded aspect-square border border-[#E3E3E3]">
                  ...
                  <div className="absolute top-2 right-2 p-2">
                    ...
                    >
                      <path
                        d="M3.71429 28.2389L13 24.1778L22.2857 28.2389V3.77778H3.71429V28.2389ZM0 34V3.77778C0 2.73889 0.364 1.84922 1.092 1.10878C1.81876 0.369592 2.69286 0 3.71429 0H22.2857C23.3071 0 24.1819 0.369592 24.9099 1.10878C25.6366 1.84922 26 2.73889 26 3.77778V34L13 28.3333L0 34Z"
                        fill="#E3E3E3"
                      />
                    </svg>
                  </div>
                ...
                <div>
                  <h4 className="text-black text-xl font-medium font-['SF_Pro_Display'] leading-tight line-clamp-1">
                    {piece.title}
                  </h4>
                  <p className="text-black text-[15px] leading-5 font-['SF_Pro_Display'] line-clamp-2">
          ...
          <div className="flex justify-end">
            <button className="px-5 py-2 text-[#486B91] text-[15px] font-medium leading-5 font-['Public_Sans'] hover:underline">
      ...
      <section className="bg-black px-6 md:px-12 py-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center gap-8 p-6">
            <svg
              width="96"
              height="96"
              viewBox="0 0 97 97"
            ...
            >
              <path
                d="M92.4952 48.3379L82.7352 37.1779L84.0952 22.4179L69.6552 19.1379L62.0952 6.37793L48.4952 12.2179L34.8952 6.37793L27.3352 19.1379L12.8952 22.3779L14.2552 37.1779L4.49524 48.3379L14.2552 59.4979L12.8952 74.2979L27.3352 77.5779L34.8952 90.3779L48.4952 84.4979L62.0952 90.3379L69.6552 77.5779L84.0952 74.2979L82.7352 59.5379L92.4952 48.3379ZM76.6952 54.2579L74.4552 56.8579L74.7752 60.2579L75.4952 68.0579L67.8952 69.7779L64.5352 70.5379L62.7752 73.4979L58.8152 80.2179L51.6952 77.1379L48.4952 75.7779L45.3352 77.1379L38.2152 80.2179L34.2552 73.5379L32.4952 70.5779L29.1352 69.8179L21.5352 68.0979L22.2552 60.2579L22.5752 56.8579L20.3352 54.2579L15.1752 48.3779L20.3352 42.4579L22.5752 39.8579L22.2152 36.4179L21.4952 28.6579L29.0952 26.9379L32.4552 26.1779L34.2152 23.2179L38.1752 16.4979L45.2952 19.5779L48.4952 20.9379L51.6552 19.5779L58.7752 16.4979L62.7352 23.2179L64.4952 26.1779L67.8552 26.9379L75.4552 28.6579L74.7352 36.4579L74.4152 39.8579L76.6552 42.4579L81.8152 48.3379L76.6952 54.2579Z"
                fill="#F1E7D3"
              />
              <path
                d="M60.4043 42.5597L62.6202 37.6847L67.4952 35.4688L62.6202 33.2529L60.4043 28.3779L58.1884 33.2529L53.3134 35.4688L58.1884 37.6847L60.4043 42.5597Z"
                fill="#F1E7D3"
              />
              <path
                d="M60.4043 53.1963L58.1884 58.0713L53.3134 60.2872L58.1884 62.5031L60.4043 67.3781L62.6202 62.5031L67.4952 60.2872L62.6202 58.0713L60.4043 53.1963Z"
                fill="#F1E7D3"
              />
              <path
                d="M47.1089 43.4463L42.6771 33.6963L38.2452 43.4463L28.4952 47.8781L38.2452 52.3099L42.6771 62.0599L47.1089 52.3099L56.8589 47.8781L47.1089 43.4463ZM44.4321 49.6331L42.6771 53.4977L40.9221 49.6331L37.0575 47.8781L40.9221 46.1231L42.6771 42.2586L44.4321 46.1231L48.2966 47.8781L44.4321 49.6331Z"
                fill="#F1E7D3"
              />
            </svg>
            <div>
              <h3 className="text-[#F1E7D3] text-[28px] font-medium leading-8 tracking-[-0.01em] mb-3 font-['SF_Compact_Display']">
                {dict.landing.features.registerIP.title}
              </h3>
              <p className="text-[#D6DDE6] text-[17px] font-['SF_Compact'] leading-7">
                {dict.landing.features.registerIP.description}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-8 p-6">
            ...
            >
              <path
                d="M76.6152 14.6179C69.9352 9.05788 61.6552 5.41788 52.4952 4.57788V12.6179C59.4152 13.3779 65.7352 16.1379 70.9352 20.2979L76.6152 14.6179Z"
                fill="#F1E7D3"
              />
              <path
                d="M44.4952 12.6179V4.57788C35.3352 5.37788 27.0552 9.05788 20.3752 14.6179L26.0552 20.2979C31.2552 16.1379 37.5752 13.3779 44.4952 12.6179Z"
                fill="#F1E7D3"
              />
              <path
                d="M20.4153 25.9378L14.7353 20.2578C9.17525 26.9378 5.53525 35.2178 4.69525 44.3778H12.7353C13.4953 37.4578 16.2553 31.1378 20.4153 25.9378Z"
                fill="#F1E7D3"
              />
              <path
                d="M84.2553 44.3778H92.2953C91.4553 35.2178 87.8153 26.9378 82.2553 20.2578L76.5753 25.9378C80.7353 31.1378 83.4953 37.4578 84.2553 44.3778Z"
                fill="#F1E7D3"
              />
              <path
                d="M28.4952 48.3779L42.2552 54.6179L48.4952 68.3779L54.7352 54.6179L68.4952 48.3779L54.7352 42.1379L48.4952 28.3779L42.2552 42.1379L28.4952 48.3779Z"
                fill="#F1E7D3"
              />
              <path
                d="M48.4952 84.3779C36.0552 84.3779 25.0952 78.0179 18.6552 68.3779H28.4952V60.3779H4.49524V84.3779H12.4952V73.5779C20.4552 84.9379 33.5752 92.3779 48.4952 92.3779C67.9752 92.3779 84.4952 79.6979 90.2552 62.1379L82.4152 60.3379C77.4952 74.2979 64.1752 84.3779 48.4952 84.3779Z"
                fill="#F1E7D3"
              />
            </svg>
            <div>
              <h3 className="text-[#F1E7D3] text-[28px] font-medium leading-8 tracking-[-0.01em] mb-3 font-['SF_Compact_Display']">
                {dict.landing.features.remixArt.title}
              </h3>
              <p className="text-[#D6DDE6] text-[17px] font-['SF_Compact'] leading-7">
                {dict.landing.features.remixArt.description}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-8 p-6">
            ...
            >
              <path
                d="M56.7352 40.1379L48.4952 36.3779L56.7352 32.6179L60.4952 24.3779L64.2552 32.6179L72.4952 36.3779L64.2552 40.1379L60.4952 48.3779L56.7352 40.1379ZM16.4952 56.3779L20.2552 48.1379L28.4952 44.3779L20.2552 40.6179L16.4952 32.3779L12.7352 40.6179L4.49524 44.3779L12.7352 48.1379L16.4952 56.3779ZM34.4952 36.3779L38.8552 26.7379L48.4952 22.3779L38.8552 18.0179L34.4952 8.37793L30.1352 18.0179L20.4952 22.3779L30.1352 26.7379L34.4952 36.3779ZM18.4952 82.3779L42.4952 58.3379L58.4952 74.3379L92.4952 36.0979L86.8552 30.4579L58.4952 62.3379L42.4952 46.3379L12.4952 76.3779L18.4952 82.3779Z"
                fill="#F1E7D3"
              />
            </svg>
            <div>
              <h3 className="text-[#F1E7D3] text-[28px] font-medium leading-8 tracking-[-0.01em] mb-3 font-['SF_Compact_Display']">
                {dict.landing.features.releaseRemix.title}
              </h3>
              <p className="text-[#D6DDE6] text-[17px] font-['SF_Compact'] leading-7">
                {dict.landing.features.releaseRemix.description}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-col md:flex-row items-center bg-[#F1E7D3]">
        ...
        <div className="w-full md:w-1/2 px-6 md:px-12 py-12">
          <h2 className="text-black text-[32px] font-semibold mb-9">
      ...
      <section className="px-6 md:px-12 py-12">
        <h2 className="text-black text-5xl font-bold leading-tight tracking-[-0.01em] text-center mb-12 font-['Plus_Jakarta_Sans']">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h4 className="text-black text-[15px] font-bold leading-5 font-['Plus_Jakarta_Sans']">
                    {testimonial.name}
                  </h4>
                  <p className="text-[#E3E3E3] text-[15px] font-medium leading-5 font-['Plus_Jakarta_Sans']">
                    {testimonial.role}
                  </p>
                </div>
              </div>
              <div className="flex gap-3 opacity-80 pb-2">
                <div className="w-12 flex items-center justify-center">
                  ...
                  >
                    <path
                      d="M1 0.37793V96.3779"
                      stroke="black"
                      strokeWidth="1.5"
                    />
                  </svg>
                </div>
                <p className="flex-1 text-[#2C2C2C] text-xl font-medium leading-6 font-['Plus_Jakarta_Sans']">
                  {testimonial.quote}
                </p>
              </div>
            </div>
